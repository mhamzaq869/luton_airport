...
@section('title', trans('auth.page_title_register'))
...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        @if ( trans('auth.intro_register') )
            <p class="register-box-msg">{{ trans('auth.intro_register') }}</p>
        @endif

        <form role="form" method="POST" action="{{ route('register') }}" class="form-master">
            {{ csrf_field() }}

            <div class="form-group form-group-lg has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="name">{{ trans('auth.name') }}</label>
                <div>
                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="{{ trans('auth.name') }}" required autofocus>
            ...
            <div class="form-group form-group-lg has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div>
                    <input type="password" class="form-control" id="password" name="password" value="{{ old('password') }}" placeholder="{{ trans('auth.password') }}" required>
            ...
            <div class="form-group form-group-lg has-feedback{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <div>
                    <input type="password" class="form-control" id="password-confirm" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="{{ trans('auth.password_confirmation') }}" required>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
