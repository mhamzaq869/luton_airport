...
@section('title', trans('admin/vehicles.page_title'))
@section('subtitle', /*'<i class="fa fa-car"></i> '.*/ trans('admin/vehicles.page_title'))
...
@section('subfooter')
    ...
    function updateTableHeight() {
       var height = parseFloat($('.wrapper > .content-wrapper').css('min-height')) -
        ...
        //    height = 0;
        // }
        $('#vehicles .dataTables_scrollBody').css({'min-height': height +'px'});
    }
