...
@section('title', trans('admin/feedback.page_title'))
@section('subtitle', /*'<i class="fa fa-comments-o"></i> '.*/ trans('admin/feedback.page_title'))
...
@section('subfooter')
  ...
  function updateTableHeight() {
     var height = parseFloat($('.wrapper > .content-wrapper').css('min-height')) -
      ...
      //  height = 0;
      // }
      $('#feedback .dataTables_scrollBody').css({'min-height': height +'px'});
  }
