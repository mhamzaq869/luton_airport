...
@section('title', trans('admin/zones.page_title'))
@section('subtitle', /*'<i class="fa fa-map-marker"></i> '. */trans('admin/zones.page_title'))
...
@section('subfooter')
    ...
    function updateTableHeight() {
       var height = parseFloat($('.wrapper > .content-wrapper').css('min-height')) -
        ...
        //    height = 0;
        // }
        $('#zones .dataTables_scrollBody').css({'min-height': height +'px'});
    }
