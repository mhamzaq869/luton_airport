...
@section('title', trans('admin/scheduled_routes.page_title'))
@section('subtitle', /*'<i class="fa fa-compass"></i> '.*/ trans('admin/scheduled_routes.page_title'))
...
@section('subfooter')
  ...
  function updateTableHeight() {
   var height = parseFloat($('.wrapper > .content-wrapper').css('min-height')) -
    ...
    //  height = 0;
    // }
    $('#scheduled-routes .dataTables_scrollBody').css({'min-height': height +'px'});
  }
