...
@section('title', trans('admin/users.page_title'))
@section('subtitle', /*'<i class="fa fa-users"></i> '.*/ trans('admin/users.page_title'))
...
@section('subfooter')
    ...
    function updateTableHeight() {
       var height = parseFloat($('.wrapper > .content-wrapper').css('min-height')) -
        ...
        //    height = 0;
        // }
        $('#users .dataTables_scrollBody').css({'min-height': height +'px'});
    }
