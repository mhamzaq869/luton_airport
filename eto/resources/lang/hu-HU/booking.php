...
return [
    ...
    */
    ...
    'page_title' => 'Foglalás',
    'page_title_availability' => 'Elérhetőség',
    ...
    'calendar' => [
        'booked' => 'Foglalt',
        'base_to_start' => 'Mennyi idő odaérni',
        'start_to_end' => 'A foglalásod',
        'end_to_base' => 'A sofőr visszaútja',
    ],
    'navigate' => 'Navigál',
    'navigate_to_pickup' => 'Navigálás a felevételi ponthoz',
    'navigate_to_dropoff' => 'Navigálás az uticélhoz',
    'navigate_to_via' => 'Navigálás keresztül',
    'from' => 'Utasfelvétel',
    'to' => 'Uticél',
    'via' => 'Keresztül',
    'date' => 'Idő',
    'one_way' => 'Oda út',
    'return' => 'Oda-vissza',
    'ref_number' => 'Referenciaszám',
    'vehicle' => 'Autó',
    'lead_passenger_name' => 'Név',
    'lead_passenger_email' => 'E-mail cím',
    'lead_passenger_mobile' => 'Telefonszám',
    'passengers' => 'Utasok',
    'child_seats' => 'Gyermekülés',
    'baby_seats' => 'Ülésmagasító',
    'infant_seats' => 'Csecsemőülés',
    'wheelchair' => 'Tolókocsi',
    'luggage' => 'Bőröndök',
    'hand_luggage' => 'Kabin csomag',
    'full_address' => 'Teljes cím',
    'flight_number' => 'Járatszám',
    'flight_landing_time' => 'Járat érkezik',
    'departure_city' => 'Honnan érkezik',
    ...
    'waiting_time_after' => ':time perccel a leszállás után',
    'meet_and_greet' => 'Terminálban várakozás',
    'meet_and_greet_required' => 'Szükséges',
    'meeting_point' => 'Találkozási pont',
    'requirements' => 'Speciális instrukciók',
    'contact_name' => 'Név',
    'contact_email' => 'E-mail',
    'contact_mobile' => 'Telefonszám',
    'ref_number_quoted' => 'Árajánlat ID',
    'created_date' => 'Foglalás napja',
    'created_date_quoted' => 'Beküldve',
    'summary' => 'Összesítés',
    'price' => 'Fuvardíj',
    'journey_type' => 'Fuvar típus',
    'return' => 'Visszaút',
    'payments' => 'Fizetés',
    'payment_method' => 'Fizetési mód',
    'payment_price' => 'Fizetési díj',
    'discount_code' => 'Kedvezmény kód',
    'discount_price' => 'Kedvezmény',
    'total_price' => 'Összesen',
    'deposit' => 'Előleg',
    'status' => 'Státus',
    'service_type' => 'A szolgáltatás típusa',
    'service_duration' => 'Időtartam',
    'heading' => [
        'journey' => 'Utazás részletei',
        'customer' => 'Utas adatai',
        'lead_passenger' => 'Vezető utas adatai',
        'reservation' => 'Foglalás adatai',
    ...
    'summary_types' => [
        ...
        'meet_and_greet' => 'Terminálban várakozás',
        'child_seat' => 'Gyermekülés',
        'baby_seat' => 'Ülésmagasító',
        'infant_seat' => 'Csecsemőülés',
        'wheelchair' => 'Mozgáskorlátozottak',
        'waiting_time' => 'Várakozási idő',
        'luggage' => 'Bőrönd',
        'hand_luggage' => 'Kabin csomag',
        'other' => 'Díj',
