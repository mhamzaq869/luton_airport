...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | French (fr-FR) - Notifications
    |--------------------------------------------------------------------------
    */

    'booking_pending' => [
        'subject' => 'Nouvelle réservation :ref_number',
        'message' => 'Nouvelle réservation :ref_number a été créée.',
        // 'subject_customer' => ':company_name réservation :ref_number',
        // 'message_customer' => 'Merci pour votre réservation :ref_number.',
    ...
    'booking_quote' => [
        'subject' => 'Nouvelle réservation :ref_number demande de devis',
        'message' => 'Nouvelle réservation :ref_number demande de devis en attente d\'examen.',
        'subject_customer' => ':company_name réservation :ref_number demande de devis',
    ...
    'booking_invoice' => [
        'subject' => "Facture d'achat :ref_number",
        'message' => 'Veuillez trouver votre facture :ref_number ci-dessous.',
    ],
    'greeting' => [
        'general' => 'Cher(e) :Name,',
        'default' => 'Salut!',
    ...
    'reason' => 'Raison﻿',
    'link_view' => 'Découvre',
    'salutation' => 'Salutions',
    'sub_copy' => 'Si vous rencontrez des difficultés en cliquant sur le bouton ":name", copiez et collez l\'URL ci-dessous dans votre navigateur Web:',
    'footer' => [
        'phone' => 'Tél',
        'email' => 'Messagerie',
        'site' => 'Site internet',
