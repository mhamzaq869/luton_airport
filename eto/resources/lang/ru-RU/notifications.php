...
return [
    ...
    */
    ...
    'greeting' => [
        'general' => 'Уважаемый :Name,',
        'default' => 'Здравствуйте!',
        'error' => 'Упс!',
    ],
    'reason' => 'Причина',
    'link_view' => 'Посмотреть',
    'salutation' => 'С уважением',
    'sub_copy' => 'Если у вас возникли проблемы с нажатием кнопки ":name", скопируйте и вставьте URL-адрес ниже в свой веб-браузер:',
    'footer' => [
        'phone' => 'Тел.',
