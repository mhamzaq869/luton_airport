...
return array(
    ...
    'properties' => [
        'creator'        => 'EasyTaxiOffice',
        'lastModifiedBy' => 'EasyTaxiOffice',
        'title'          => 'Spreadsheet',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'EasyTaxiOffice, excel, export',
        'category'       => 'Excel',
        'manager'        => 'EasyTaxiOffice',
        'company'        => 'EasyTaxiOffice',
    ],
        ...
        'pdf'                         => [
            ...
            */
            'drivers' => [
                ...
                */
                'mPDF'   => [
                    'path' => base_path('vendor/mpdf/mpdf/src/')
                ],
            ]
        ]
    ],
