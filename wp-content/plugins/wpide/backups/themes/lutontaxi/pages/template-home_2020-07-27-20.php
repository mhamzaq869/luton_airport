...
<!--					</div>-->
                    <h1>Luton Airport hassle <span class="free-transfer-service">free transfer service.</span></h1>
                    <img src="https://lutonairport.taxi/wp-content/uploads/2018/12/standard-cars.png">
				</div>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="payment-options">
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/wechat-icon.png" alt="Pay with WeChat with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/visa-icon.png" alt="Pay with Visa card with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/master-icon.png" alt="Pay with Mastercard with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/paypal-icon.png" alt="Pay with PayPal with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/apple-pay.png" alt="Pay with Apple Pay with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/android-pay.png" alt="Pay with Android Pay with Luton Airport Taxi"></a>
					<a href="javascript:void(0);"><img src="<?php echo get_template_directory_uri(); ?>/images/amex.png" alt="Pay with Amex with Luton Airport Taxi"></a>
				</div>
			</div>
		</div>
	</div>
    ...
    border: 1px solid;
			...
			<div class="slider slider-single">
				 <div class="image-wrap">
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/12/standard-cars.png" alt="Luxurious Standard Cars at Luton Airport Taxi">
               </div>
               <div class="image-wrap">
                    <div class="image-text-wrap">
                        <span>4 <small>Adult</small></span>
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/12/larg-cars.png" alt="Luxurious Large Cars at Luton Airport Taxi">
               </div>
                <div class="image-wrap">
                    <div class="image-text-wrap">
                        ...
                        <img src="<?php echo site_url();?>/wp-content/uploads/2019/02/benz.png" alt="Luxurious Benz Cars at Luton Airport Taxi">
               </div>
               <div class="image-wrap">
                    <div class="image-text-wrap">
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2019/02/small-car.png" alt="Luxurious Small Cars at Luton Airport Taxi">
               ...
               <div class="image-wrap">
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/12/mini-bus-car.png" alt="Luxurious Mini Bus Cars at Luton Airport Taxi">
               </div>
               <div class="image-wrap">
                    <div class="image-text-wrap">
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2019/01/10-van.png" alt="Luxurious VAN Cars at Luton Airport Taxi">
               </div>
                <div class="image-wrap">
                    <div class="image-text-wrap">
                        <span>4 <small>Adult</small></span>
                    ...
                    <img src="<?php echo site_url();?>/wp-content/uploads/2019/02/rangerover.png" alt="Luxurious RangeRover Cars at Luton Airport Taxi">
               </div>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/24-hours-icon-image.png" alt="24x7 Luton Airport Taxi Services">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/booking-icon.png" alt="Prebooking Luton Airport Taxi Services">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/sms-icon.png" alt="Contact Luton Airport Taxi Services with SMS">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/fying-jet-icon.png" alt="Luton Airport Taxi Services">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/maddle-icon.png" alt="Luton Airport Taxi Transfer">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/user-icons.png" alt="Luton Airport Taxi Transfer Services">
						<h5>Meet & Greet</h5>
					</a>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/wheelshair-icon.png" alt="Luton Airport to London Taxi">
			...
			<div class="col-sm-3">
				<div class="icon-wrap">
					<a href="javascript:void(0);">
						<img src="<?php echo get_template_directory_uri(); ?>/images/pound-sign-icon.png" alt="Luxurious Luton Airport Taxi">
						<h5>Fixed Price</h5>
					</a>
				</div>
			</div>
